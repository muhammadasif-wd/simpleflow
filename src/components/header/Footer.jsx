		...
		<footer className="bg-primaryColor w-full">
			<section style={{ backgroundImage: `url(${images.map})`, backgroundRepeat: 'no-repeat' }} className="bg-cover">
				<div className="w-11/12 mx-auto pt-10 flex flex-col justify-center items-center">
					{footer_items.map(({ _id, followUsMessage, aboutCompany }) => (
								...
								<article>
									...
									<div className="text-sm font-medium">
										...
										<div className="flex items-center gap-3 mt-3">
											<Link className='text-white' href='/'><Icon className="w-6 h-6" icon="bi:facebook" /></Link>
											<Link className='text-white' href='/'><Icon className="w-8 h-8" icon="bi:youtube" /></Link>
											<Link className='text-white' href='/'><Icon className="w-6 h-6" icon="bi:twitter-x" /></Link>
											<Link className='text-white' href='/'><Icon className="w-6 h-6" icon="bi:linkedin" /></Link>
										</div>
									</div>
								</article>
								<article>
